...
} from "./chunk-SFZFZ6TE.js";
import {
  AbstractAudioNode,
  _WebAudioParameterComponent
} from "./chunk-4P5RYUOC.js";
import {
  FromHalfFloat
} from "./chunk-NI6BQFM2.js";
import {
  AbstractMesh
} from "./chunk-Y3BPAVDH.js";
import {
  UniformBuffer
} from "./chunk-DUU2OLCP.js";
import {
...
import {
  ...
  HasStencilAspect,
  IsWrapper
} from "./chunk-QSMVHUBU.js";
import {
  Tools
} from "./chunk-MSDW7SPX.js";
import {
  Buffer,
  GetTypeByteLength,
  VertexBuffer
...
var WebGPUTextureManager = class {
  ...
  createMSAATexture(texture, samples, releaseExisting = true, index = 0) {
    ...
    const gpuMSAATexture = this.createTexture({ width, height, layers: 1 }, false, false, false, false, false, gpuTextureWrapper.format, samples, this._commandEncoderForCreation, 16 | 4, 0, texture.label ? "MSAA_" + texture.label : "MSAA");
...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name3, options = {}) {
    const module = await import("./webAudioBus-P3SXRS7H.js");
  ...
  async createMainBusAsync(name3, options = {}) {
    const module = await import("./webAudioMainBus-ATKIVSSP.js");
  ...
  async createSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStaticSound-7JH2COI5.js");
  ...
  async createSoundSourceAsync(name3, source, options = {}) {
    const module = await import("./webAudioSoundSource-7JKAJD5P.js");
  ...
  async createStreamingSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStreamingSound-CHGJAD33.js");
...
var WebGPUEngine = class _WebGPUEngine extends ThinWebGPUEngine {
  ...
  _startRenderTargetRenderPass(renderTargetWrapper, setClearStates, clearColor, clearDepth, clearStencil) {
    ...
    const depthTextureView = depthMSAATextureView ? void 0 : gpuDepthStencilTexture?.createView(this._rttRenderPassWrapper.depthAttachmentViewDescriptor);
...
//# sourceMappingURL=chunk-UVWAGXXU.js.map
