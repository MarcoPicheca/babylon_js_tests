...
} from "./chunk-D56FGPBW.js";
import {
  BoundingInfo,
  PickingInfo,
  SubMesh
} from "./chunk-XLJJKZGK.js";
import {
  Node
} from "./chunk-ALX6JN4K.js";
import {
  UniformBuffer
...
import {
  ...
  Texture,
  ThinTexture
} from "./chunk-GVXJ3ZC3.js";
import {
  SerializationHelper,
  Tags
} from "./chunk-ZZVSU4PI.js";
import {
  Color3,
  Color4,
  TmpColors
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-F3TKF57A.js"),
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-23RPTKNB.js"),
...
var DepthRenderer = class _DepthRenderer {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-CDKWDGR6.js"), import("./depth.fragment-W5OGO4OC.js")]);
    } else {
      await Promise.all([import("./depth.vertex-OMLI4M6B.js"), import("./depth.fragment-FB4LWFMM.js")]);
    }
    this._shadersLoaded = true;
  }
  /**
...
//# sourceMappingURL=chunk-VVANWS25.js.map
